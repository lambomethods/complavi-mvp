        ...
        <div className="prose prose-slate max-w-none space-y-8">
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed">
              Department administrator names and contact information. Participant check-in confirmation data including GPS coordinates and identity verification tokens. Platform usage data for service improvement purposes.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-600 leading-relaxed">
              <strong>Raw identity data of any kind.</strong> Identity verification is processed entirely on the participant&apos;s personal device using device-native technology. COMPLAVION receives only a secure confirmation token indicating whether verification was successful. We never see, store, or transmit facial data.
            </p>
          </div>
