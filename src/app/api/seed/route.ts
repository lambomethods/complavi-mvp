...
export async function GET() {
  try {
    ...
    // 2. Create the primary active demo participant (Replacing "Marcus T.")
    ...
    // 3. Create 11 more professional mock participants to inflate numbers
    ...
    return NextResponse.json({ 
      success: true, 
      message: "Database inflated and seeded flawlessly. 12 Professional profiles currently active.", 
    });
  } catch (error: any) {
